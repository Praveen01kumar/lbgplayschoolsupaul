...
@Component({
  ...
  template: `
    ...
    <!-- History -->
    <section class="section-padding" [attr.aria-label]="content.STORY.AREA_LABEL">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="reveal-right">
            <img [src]="content.STORY.IMAGE" loading="lazy" decoding="async" fetchpriority="high" [alt]="content.STORY.IMAGE_ALT" class="rounded-2xl shadow-2xl w-full object-cover">
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Vision & Mission -->
    <section class="bg-[#eef4ff] section-padding" [attr.aria-label]="content.PURPOSE.AREA_LABEL">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <app-section-heading [title]="content.PURPOSE.TITLE" [subtitle]="content.PURPOSE.SUBTITLE" [description]="content.PURPOSE.DESC" />
        <div class="grid md:grid-cols-2 gap-8">
          <div class="reveal bg-white rounded-2xl p-8 shadow-md border border-gray-100 card-hover">
            ...
            <h3 class="text-2xl font-bold font-heading text-dark mb-4">{{ content.PURPOSE.VISION.TITLE }}</h3>
            <p class="text-muted leading-relaxed">{{ content.PURPOSE.VISION.DESC }}</p>
          </div>
          <div class="reveal bg-white rounded-2xl p-8 shadow-md border border-gray-100 card-hover">
            ...
            <h3 class="text-2xl font-bold font-heading text-dark mb-4">{{ content.PURPOSE.MISSION.TITLE }}</h3>
            <p class="text-muted leading-relaxed">{{ content.PURPOSE.MISSION.DESC }}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Campus Overview -->
    <section class="section-padding" [attr.aria-label]="content.OUR_CAMPUS.AREA_LABEL">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <app-section-heading [title]="content.OUR_CAMPUS.TITLE" [subtitle]="content.OUR_CAMPUS.SUBTITLE" [description]="content.OUR_CAMPUS.DESC" />
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          @for (facility of content.OUR_CAMPUS.FACILITIES; track $index; let i = $index) {
    ...
    <!-- Values -->
    <section class="section-padding gradient-primary text-white" [attr.aria-label]="content.VALUES.AREA_LABEL">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <h2 class="text-3xl md:text-4xl font-bold font-heading mb-4">{{ content.VALUES.TITLE }}</h2>
          <p class="text-white/70 max-w-2xl mx-auto text-lg">{{ content.VALUES.DESC }}</p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          @for (value of content.VALUES.VALUES_LIST; track $index; let i = $index) {
            <div class="reveal bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/1 hover:bg-white/20 transition-all">
