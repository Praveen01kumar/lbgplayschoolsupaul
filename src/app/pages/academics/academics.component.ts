...
@Component({
  ...
  template: `
    ...
    <section class="section-padding" [attr.aria-label]="content.CURRICULUM.AREA_LABEL">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          <div class="reveal">
            ...
            <div class="flex flex-wrap gap-3">
              @for (tag of content.CURRICULUM.TAGS; track $index; let i = $index) {
    ...
    <section class="section-padding bg-[#eef4ff]" [attr.aria-label]="content.DEPARTMENTS.AREA_LABEL">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <app-section-heading [title]="content.DEPARTMENTS.TITLE" [subtitle]="content.DEPARTMENTS.SUBTITLE" [description]="content.DEPARTMENTS.DESC" />
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          @for (dept of content.DEPARTMENTS.DEPARTMENTS_LIST; track $index; let i = $index) {
    ...
    <section class="section-padding" [attr.aria-label]="content.PROGRAMS.AREA_LABEL">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <app-section-heading [title]="content.PROGRAMS.TITLE" [subtitle]="content.PROGRAMS.SUBTITLE" [description]="content.PROGRAMS.DESC" />
        <div class="grid md:grid-cols-3 gap-6">
          @for (program of content.PROGRAMS.PROGRAMS_LIST; track $index; let i = $index) {
            <div class="reveal bg-white rounded-2xl overflow-hidden shadow-md card-hover border border-gray-100">
              ...
              <div class="p-6">
                ...
                <ul class="space-y-2">
                  @for (feature of program.features; track $index; let i = $index) {
    ...
    <section class="section-padding gradient-primary text-white" [attr.aria-label]="content.METHODS.AREA_LABEL">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <h2 class="text-3xl md:text-4xl font-bold font-heading mb-4">{{ content.METHODS.TITLE }}</h2>
          <p class="text-white/70 max-w-2xl mx-auto">{{ content.METHODS.DESC }}</p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          @for (method of content.METHODS.METHODS_LIST; track $index; let i = $index) {
